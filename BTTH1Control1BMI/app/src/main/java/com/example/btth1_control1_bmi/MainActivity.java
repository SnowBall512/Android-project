package com.example.btth1_control1_bmi;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editChieucao= findViewById(R.id.edtCC);
        editCannang= findViewById(R.id.edtCN);
        ...
        btnChandoan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double H, W;
                    ...
                    double BMI = W / Math.pow(H / 100, 2); // Convert height to meters
                    String chandoan = "";
